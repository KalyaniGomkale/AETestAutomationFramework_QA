...
public class TenantsPageTest extends TestBase {
	...
	@Test(priority=702,alwaysRun=true)
	...
	@Test(priority=705,alwaysRun=true)
	...
	@Test(priority=706,alwaysRun=true)
	...
	@Test(priority = 1016,alwaysRun=true)
	...
	@Test(priority = 1017,alwaysRun=true)
