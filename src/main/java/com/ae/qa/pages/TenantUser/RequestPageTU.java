...
public class RequestPageTU extends TestBase{
	public WebDriverWait wait = new WebDriverWait(driver, 150);
	public WebElements webelements = new WebElements();
	public LoginPageTA loginpageta = new LoginPageTA();
	public InformationPageTA informationpageta = new InformationPageTA();
	public WorkflowListPageTU workflowpagetu = new WorkflowListPageTU();
	...
	public void AdvSearch() throws Exception {
		...
		loginpageta.login("TenantUser1","Pune@1234");
