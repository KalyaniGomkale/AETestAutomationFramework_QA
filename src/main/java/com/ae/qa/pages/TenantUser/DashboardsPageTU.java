...
public class DashboardsPageTU extends TestBase{
	...
	public DashboardsPageTU() {
		PageFactory.initElements(driver, this);
	}
	public void createNewDashboardTU(String dashboardTitle,String dashboardDescp,String timeUnit,String refreshTime,String 
	...
	public void validateDashboardNoneTU(String dashboardTitle,String dashboardDescp,String timeUnit,String refreshTime,String 
			dashboardDuration) throws Exception{
		createNewDashboardTU(dashboardTitle,dashboardDescp,timeUnit,refreshTime,dashboardDuration);
		Thread.sleep(3000);
		createBtn.click();
	...
	public void makeReportUsingWFTU(String dashboardTitle,String reportTypeValue,String wfName1) throws Exception{
		loginpageta.login(prop.getProperty("username_TU1"), prop.getProperty("password_TU1"));
		Reporter.log("User logged in successfully", true);
		//wait.until(ExpectedConditions.visibilityOf(reportsTab));
		Thread.sleep(3000);
	...
	public void validateReportNoneMultipleWFTU(String dashboardTitle,String reportTypeValue,String wfName1,String wfName2,String PageSize,
			String NewReportTitle) throws Exception{
		makeReportUsingWFTU(dashboardTitle,reportTypeValue,wfName1);
		for(int i=0;i<20;i++) {
		...
		createdReportValidationTU(NewReportTitle);
	}
	public void createdReportValidationTU(String NewReportTitle) throws InterruptedException{
		for(int i=0;i<60;i++) {
	...
	public void validateDashboardRelativeTU(String dashboardTitle,String dashboardDescp,String timeUnit,String refreshTime,String 
	...
	public void validateEditDashboardToCustomTU(String dashboardTitle,String newDashboardTitle,String dashboardDescp,String dashboardDuration,
	...
	public void validateSetAsDefaultReportTU(String dashboardTitle) throws Exception {
		loginpageta.login(prop.getProperty("username_TU1"), prop.getProperty("password_TU1"));
		Reporter.log("User logged in successfully", true);
		//wait.until(ExpectedConditions.visibilityOf(reportsTab));
		Thread.sleep(3000);
	...
	public void validateDashboardTodayTU(String dashboardTitle,String dashboardDescp,String timeUnit,String refreshTime,String 
	...
	public void validateDeleteDashboardWithReportTU(String dashboardTitle) throws Exception {
		loginpageta.login(prop.getProperty("username_TU1"), prop.getProperty("password_TU1"));
		Reporter.log("User logged in successfully", true);
		//wait.until(ExpectedConditions.visibilityOf(reportsTab));
		Thread.sleep(3000);
