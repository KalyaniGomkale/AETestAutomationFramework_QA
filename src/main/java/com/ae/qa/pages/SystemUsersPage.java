...
public class SystemUsersPage extends TestBase {
	...
	public void creation(String tenantOrgCode, String FName, String LName, String UserMail, String UserName,
		...
		WebElement select_tenant = driver.findElement(
				By.xpath("//div[@id='options-list']/li/label[contains(text(),'" + tenantOrgCode + "')]/span"));
		select_tenant.click();
		tenantdrpdownlist.click();
		Thread.sleep(2000);
	...
	public void creatingTenantLicenseAdmin(String tenantOrgCode, String FName, String LName, String UserMail,
			String UserName, String Pswd, String ConfirmPswd, String RoleName) throws Exception {
		creation(tenantOrgCode, FName, LName, UserMail, UserName, Pswd, ConfirmPswd, RoleName);
		wait.until(ExpectedConditions.visibilityOf(alertMessage));
		// Thread.sleep(3000);
		String actual_Msg = alertMessage.getText();
	...
	public void validateEditTenantLicenseAdmin(String UserName, String NewUserMail, String fPswd, String Password)
			throws Exception {
		loginpage.login(prop.getProperty("username"), prop.getProperty("password"));
		Reporter.log("User logged in successfully", true);
		// wait.until(ExpectedConditions.visibilityOf(usersTab));
		...
		Assert.assertEquals(actual_EditUserMsg, expected_EditUserMsg,
				"Tenant License Admin details not edited successfully");
	...
	public void creatingSystemAdminWithWrongPswd(String tenantOrgCode, String FName, String LName, String UserMail,
			String UserName, String Pswd, String ConfirmPswd, String RoleName) throws Exception {
		creation(tenantOrgCode, FName, LName, UserMail, UserName, Pswd, ConfirmPswd, RoleName);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", createBtn);
	...
	public void uploadLicenseForTenantLicenseAdmin(String tenantOrgCode, String FName, String LName, String UserMail,
			String UserName, String Pswd, String ConfirmPswd, String RoleName, String Password) throws Exception {
		...
		WebElement uploadBtn = driver
				.findElement(By.xpath("//table/tr/td[text()='OKTA_OpenID']/../td/span[@title='Upload License']"));
		uploadBtn.click();
	...
	public void validateDeleteSystemAdmin(String tenantOrgCode, String FName, String LName, String UserMail,
			String UserName, String Pswd, String ConfirmPswd, String RoleName) throws Exception {
		creation(tenantOrgCode, FName, LName, UserMail, UserName, Pswd, ConfirmPswd, RoleName);
		Thread.sleep(5000);
		driver.findElement(By.xpath("//table/tr/td/label[@title='" + UserName + "']")).click();
		...
		Assert.assertEquals(Actual_successMsg, Expected_successMsg, "User not deleted successfully");
		informationpage.validateSignOut();
	}
	...
	public void validateSystemUsersPage(String PageTitle) throws Exception {
		...
		Reporter.log("Actual page title displayed on screen is: " + actual_title + " and Expected " + "page title is: "
				+ expected_title, true);
...
////////////////////////////////////////For Last Name/////////////////////////////////////////////////////
	public void validateAdvSearchForLastNameEqualTo(String SearchColumn,String SearchCriteria, String advSearchFor,String PageSize) throws Exception {
		...
		for (int i = 0; i < op.size(); i++) {
			...
			Assert.assertTrue(str_LastName.equalsIgnoreCase(advSearchFor));
		}
	}
...
////////////////////////////////////////////For Calender/////////////////////////////////////////////////////////////
	...
	public void validateHandleCalenderForLastUpdated(String CreatedCriteria, String startYear, String startMonth,
	...
	public void validateCreatedNotInBetween(String CreatedCriteria, String startYear, String startMonth,
		...
		for (int i = 0; i < op.size(); i++) {
			...
			System.out.println(d1.compareTo(d3) > 0);
			Assert.assertTrue(
					(d1.compareTo(d2) < 0 & d1.compareTo(d3) < 0) || (d1.compareTo(d2) > 0 & d1.compareTo(d3) > 0));
			Reporter.log("User is getting correct records for created on date with after criteria", true);
		}
	}
////////////////////////////////For Last Updated////////////////////////////////////////////////////////////////
